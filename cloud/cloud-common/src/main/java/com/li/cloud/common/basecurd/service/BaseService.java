package com.li.cloud.common.basecurd.service;
...
public interface BaseService {
    ...
    /**
     * @desc: 批量删除（针对id为数字类型），指定字段且指定字段值， 默认以逗号分割
     * @param: entity 实体对象
     ...
     * @date: 2019-06-14
     */
    <T> int deleteBatch(Class<T> entityClass, String deleteField, String deleteVals);
