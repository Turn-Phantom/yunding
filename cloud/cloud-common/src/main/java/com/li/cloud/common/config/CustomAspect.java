...
public class CustomAspect {
     ...
     * @param: point 方法参数集合
     */
    @Before("@annotation(com.li.cloud.common.annotations.CustomPage)") // 处理含有CustomPage注解的方法
     ...
     * @param: returnValue
     */
    @AfterReturning(returning="returnValue", pointcut = "execution(public * com.li.cloud.*.service..*.*(..))&&@annotation(com.li.cloud.common.annotations.CustomPage)")
