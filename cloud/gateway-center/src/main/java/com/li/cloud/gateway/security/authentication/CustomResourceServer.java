...
import com.li.cloud.gateway.security.configuration.ValidateCodeSecurityConfig;
import com.li.cloud.gateway.security.constant.FinalUrl;
import com.li.cloud.gateway.security.mobile.configuration.SmsAuthenticationConfiguration;
...
public class CustomResourceServer extends ResourceServerConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        http.apply(validateCodeSecurityConfig) // 应用验证码安全配置
                ...
                .authorizeRequests()
                .antMatchers(
                        FinalUrl.LOGIN_PROCESSOR, // 表单登录处理请求
