package com.yunding.server.common.spring;
...
public class CustomAspect {
     ...
     * @date: 2019-10-31
     */
    @Before("@annotation(com.yunding.server.common.annotations.CustomPage)") // 处理含有CustomPage注解的方法
     ...
     * @date: 2019-10-31
     */
    @AfterReturning(returning="returnValue", pointcut = "execution(public * com.yunding.server..*.service..*.*(..))&&@annotation(com.yunding.server.common.annotations.CustomPage)")
