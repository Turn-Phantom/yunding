...
import com.online.yunding.config.SmsProvider;
import com.online.yunding.config.SmsProviderConf;
import com.online.yunding.dao.SmsInterfaceDao;
...
import com.online.yunding.utils.ParseXml;
...
public class SmsInterfaceServiceImpl implements SmsInterfaceService {
    ...
    public Map<String, String> querySmsNum() {
        ...
        Map<String, String> retMap = ParseXml.toMap(response);
    ...
    public Map<String, String> sendSmsCode(String phone, String content) {
        ...
        Integer surpure = (Integer) redisTemplate.opsForValue().get(ConstantUtil.SMS_SURPLUS_NUM);
        if(null != surpure && surpure < 5){
            throw new ValidateCodeException("发送验证码错误，请及时联系客服处理");
        }
    ...
    private Map<String, String> sendMessage(String phone, String content){
        ...
        return ParseXml.toMap(response);
    }
    ...
    private void saveSurplusSms(Map<String, String> retMap){
        ...
        redisTemplate.opsForValue().set(ConstantUtil.SMS_SURPLUS_NUM, surplus, 185, TimeUnit.MINUTES);
    }
