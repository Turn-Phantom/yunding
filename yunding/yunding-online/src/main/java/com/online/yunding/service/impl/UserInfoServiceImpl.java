...
import com.online.yunding.common.utils.HttpClientUtils;
import com.online.yunding.common.utils.NumberUtils;
import com.online.yunding.common.utils.PasswordUtil;
import com.online.yunding.dao.UserInfoDao;
import com.online.yunding.entity.*;
...
import com.online.yunding.service.UserOperateLogService;
...
public class UserInfoServiceImpl implements UserInfoService {
    ...
    public String register(Map<String, String> registerData, HttpServletRequest request) {
        ...
        if(!StringUtils.isEmpty(registerData.get("parentVipNo"))){
            userInfo.setParentVipNo(Integer.valueOf(registerData.get("parentVipNo")));
        }
        try {
    ...
    /** 同步云顶娱乐注册 */
    private String reqYunDingReg(Map<String, String> registerData){
        ...
        try {
            ...
            logger.info("同步云顶平台注册失败：" + e.getMessage());
        }
        return registerRes;
    }
